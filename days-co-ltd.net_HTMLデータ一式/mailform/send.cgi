...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'hiroyukikano001@gmail.com';

#06.送信元アドレス
$conf{'from'} = 'contact@days-co-ltd.net';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'https://www.days-co-ltd.net/mailform/thanks.html';
